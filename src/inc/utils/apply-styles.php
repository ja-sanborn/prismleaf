...
if ( ! function_exists( 'prismleaf_build_palette_css_key_map' ) ) {
	...
	function prismleaf_build_palette_css_key_map( $palette_slug ) {
		...
		return array(
			"--prismleaf-color-{$slug}-surface-on"           => 'on',
			"--prismleaf-color-{$slug}-surface-1"            => '1',
			"--prismleaf-color-{$slug}-surface-2"            => '2',
			"--prismleaf-color-{$slug}-surface-3"            => '3',
			"--prismleaf-color-{$slug}-surface-4"            => '4',
			"--prismleaf-color-{$slug}-surface-5"            => '5',
			"--prismleaf-color-{$slug}-outline"              => 'outline',
			"--prismleaf-color-{$slug}-outline-variant"      => 'outline_variant',
			"--prismleaf-color-{$slug}-muted-on"             => 'on_surface_muted',
...
if ( ! function_exists( 'prismleaf_build_neutral_palette_css_vars' ) ) {
	...
	function prismleaf_build_neutral_palette_css_vars( $scheme, $palette_values ) {
		...
		$key_map = array(
			...
			"--prismleaf-color-{$scheme}-muted-on"        => 'on_surface_muted',
			"--prismleaf-color-{$scheme}-disabled-foreground" => 'disabled_foreground',
			"--prismleaf-color-{$scheme}-disabled-surface"    => 'disabled_surface',
			"--prismleaf-color-{$scheme}-container-on"        => 'container_on',
			"--prismleaf-color-{$scheme}-container-1"         => 'container_1',
			"--prismleaf-color-{$scheme}-container-2"         => 'container_2',
			"--prismleaf-color-{$scheme}-container-3"         => 'container_3',
			"--prismleaf-color-{$scheme}-container-4"         => 'container_4',
			"--prismleaf-color-{$scheme}-container-5"         => 'container_5',
		);
...
if ( ! function_exists( 'prismleaf_get_header_css_vars' ) ) {
	...
	function prismleaf_get_header_css_vars() {
		...
		$surface          = prismleaf_get_theme_mod_palette_source_value( 'prismleaf_header_background_color_palette', '1', '--prismleaf-color-surface-2' );
...
if ( ! function_exists( 'prismleaf_get_footer_css_vars' ) ) {
	...
	function prismleaf_get_footer_css_vars() {
		...
		$surface          = prismleaf_get_theme_mod_palette_source_value( 'prismleaf_footer_background_color_palette', '1', '--prismleaf-color-surface-2' );
...
if ( ! function_exists( 'prismleaf_get_current_sidebar_css_vars' ) ) {
	...
	function prismleaf_get_current_sidebar_css_vars( $sidebar ) {
		...
		$surface          = prismleaf_get_theme_mod_palette_source_value( "prismleaf_sidebar_{$sidebar}_background_color_palette", '1', '--prismleaf-color-surface-2' );
