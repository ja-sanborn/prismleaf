...
if ( ! function_exists( 'prismleaf_get_palette_label_map' ) ) {
	...
	function prismleaf_get_palette_label_map() {
		return array(
			...
			'surface_on_muted'    => __( 'Shade Text Muted', 'prismleaf' ),
			'surface_on_faded'    => __( 'Shade Text Faded', 'prismleaf' ),
			...
			'container_on_muted'  => __( 'Variant Text Muted', 'prismleaf' ),
			'container_on_faded'  => __( 'Variant Text Faded', 'prismleaf' ),
			'outline'             => __( 'Outline', 'prismleaf' ),
