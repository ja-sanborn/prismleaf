...
$copyright_text = trim( prismleaf_get_theme_mod_string( 'prismleaf_footer_copyright_text', '' ) );
if ( '' === $copyright_text ) {
...
<div class="prismleaf-footer prismleaf-footer-layout">
	<?php if ( $has_footer_widgets ) : ?>
		<div class="prismleaf-footer-row prismleaf-footer-row-widgets prismleaf-footer-align-<?php echo esc_attr( $widget_alignment ); ?>">
